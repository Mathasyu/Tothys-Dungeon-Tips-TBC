...
- Explicit `tipsMap_deDE` translated/overridden NPC entries: **408** (51.2%)
- `tipsMap_deDE` entries still falling back to English because no explicit German override exists: **389**
- Duplicate explicit `tipsMap_deDE` assignments: **0**
- Structural `enUS`/`deDE` tip mismatches: **19**
...
- The German tip map does **not** appear fully translated yet. `389` NPC entries still rely on the deep-copy fallback from `tipsMap_enUS`.
...
- `19` suspicious structural mismatch(es) were found while comparing explicit `deDE` overrides against `enUS`.
...
- `tipsMap_deDE[17959]` has 1 tips, but `tipsMap_enUS[17959]` has 2.
- `tipsMap_deDE[17960]` has 1 tips, but `tipsMap_enUS[17960]` has 4.
- `tipsMap_deDE[17961]` has 1 tips, but `tipsMap_enUS[17961]` has 4.
- `tipsMap_deDE[17962]` has 1 tips, but `tipsMap_enUS[17962]` has 2.
