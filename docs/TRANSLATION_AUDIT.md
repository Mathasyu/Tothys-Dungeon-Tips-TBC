...
- Open: fully identical explicit `deDE` overrides still left to translate: **443**
- Open: partially translated overrides still left to finish: **4**
